...
**Elon Muskâs Grok Chatbot Shares Antisemitic Posts on X**\
`The artificial intelligence chatbot, which has a dedicated account on X, praised Hitler after fielding a query about a userâs comments on the Texas flood.`\
https://nytimes.com/2025/07/08/technology/grok-antisemitism-ai-x.html

**American Kennel Club Harms French Bulldogsâ Health, PETA Says in Suit**\
`The animal rights group argues that the standards the kennel club promotes for several dog breeds, including Americaâs most popular one, cause physical deformities.`\
...
**Abbott Calls Seeking Blame for Floods âthe Word Choice of Losersâ**\
`As both the death toll and number of questions about official preparedness increased, the Texas governor invoked football metaphors, saying âevery team makes mistakes.â`\
