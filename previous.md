...
**Digging into Chargers' run defense struggles ahead of matchup with high-octane Colts**\
`The Chargers aredealing with issues with personnel, performance and scheme. They must get them corrected with a big test awaiting.`\
https://nytimes.com/athletic/6724646/2025/10/17/chargers-run-defense-problems-colts-jonathan-taylor/

**Lowetide: Oilers' pending roster decisions mean tough choices for management**\
`Injured players are returning, so Oilers management will need to make some moves in the days to come.`\
https://nytimes.com/athletic/6720931/2025/10/17/edmonton-oilers-roster-ike-howard-alec-regula/

**Notre Dame vs. USC predictions: In a star-studded rivalry, watch the trenches**\
`A win puts Notre Dame on a glide path to the CFP. A loss would send Marcus Freeman back to the drawing board.`\
https://nytimes.com/athletic/6724634/2025/10/17/notre-dame-usc-predictions-matchups/
